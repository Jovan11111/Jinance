...
class TestReportInformation:
    ...
    def test__create__report_infromation__fields_have_given_values(self, create_report_info: ReportInformation, create_earn_info: EarningsInformation, create_price_perf: PricePerformanceInformation, create_news_article: NewsArticle):
    ...
    def test__to_dict_report_information__dict_with_given_values(self, create_report_info: ReportInformation, create_earn_info: EarningsInformation, create_price_perf: PricePerformanceInformation, create_news_article: NewsArticle):
