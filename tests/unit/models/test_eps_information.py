...
class TestEpsInformation:
    ...
    def test__create_eps_information__fields_have_given_values(
        self, create_eps_info: EpsInformation
    ):
    ...
    def test__to_dict_eps_information__dict_returned_with_given_values(
        self, create_eps_info: EpsInformation
    ):
