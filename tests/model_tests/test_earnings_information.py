...
class TestEarningsInformation:
    ...
    def test__create_earnings_information__fields_have_given_values(self):
        """Test that EarningsInformation is created correctly."""
        epsi = EpsInformation(avg=1.5, low=1.2, high=1.8)
        ei = EarningsInformation(
            ticker="ticker",
            name="company.",
    ...
    def test__to_dictearnings_information__dict_returned_with_given_values(self):
